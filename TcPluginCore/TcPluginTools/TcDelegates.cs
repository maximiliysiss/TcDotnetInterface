...
[Serializable]
public delegate int ProgressCallbackW(
    int pluginNumber,
...
[Serializable]
public delegate void LogCallbackW(
    int pluginNumber,
    int messageType,
...
[Serializable]
[return: MarshalAs(UnmanagedType.Bool)]
public delegate bool RequestCallbackW(
    int pluginNumber,
    int requestType,
...
[Serializable]
public delegate int FsCryptCallback(
    int pluginNumber,
    int cryptoNumber,
    int mode,
...
[Serializable]
public delegate int FsCryptCallbackW(
    int pluginNumber,
    int cryptoNumber,
    int mode,
...
[Serializable]
public delegate int ProcessDataCallback(
    [MarshalAs(UnmanagedType.LPStr)] string fileName,
    int size);

[Serializable]
public delegate int ProcessDataCallbackW(
    [MarshalAs(UnmanagedType.LPWStr)] string fileName,
    int size);

[Serializable]
public delegate int ChangeVolCallback(
    [MarshalAs(UnmanagedType.LPStr)] string arcName,
    int mode);

[Serializable]
public delegate int ChangeVolCallbackW(
    [MarshalAs(UnmanagedType.LPWStr)] string arcName,
    int mode);

[Serializable]
public delegate int PkCryptCallback(
    int cryptoNumber,
    int mode,
...
[Serializable]
public delegate int PkCryptCallbackW(
    int cryptoNumber,
    int mode,
